...
@section('title', 'Create Material Attribute Value')
@section('content')
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card mx-auto w-50">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Create Material Attribute Value</h4>
                    <div>
                        <a href="{{ route('am.material-attribute-value.index') }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('am.material-attribute-value.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="material_attribute_id" class="form-control" id="material_attribute_id">
                                        <option value="" selected hidden>Select Material Attribute</option>
