...
@section('title', 'Edit Sticker Type Material')
@section('content')
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Edit Sticker Type Material</h4>
                    <div>
                        <a href="{{ route('am.sticker-type-material.index') }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('am.sticker-type-material.update', encrypt($sticker_type_material->id)) }}') }}" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="sticker_type_id" class="form-control" id="sticker_type_id">
                                        <option value="{{ $sticker_type_material->stickerType->id }}" selected hidden>{{ $sticker_type_material->stickerType->name }}</option>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="material_id" class="form-control" id="material_id">
                                        <option value="{{ $sticker_type_material->material->id }}" selected hidden>{{ $sticker_type_material->material->name }}</option>
