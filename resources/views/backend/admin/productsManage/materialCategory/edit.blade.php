...
@section('content')
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Edit Material Category</h2>
            <a href="{{ route('admin.material-category.index') }}" class="btn btn-primary btn-md">Back</a>
        </div>
        <form action="{{ route('admin.material-category.update', encrypt($material_categories->id)) }}" method="POST"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $material_categories->title }}"
                            id="title">
                        @error('title')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" class="form-control" value="{{ $material_categories->slug }}"
                            id="slug">
                        @error('slug')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5">{{ $material_categories->description }}</textarea>
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
