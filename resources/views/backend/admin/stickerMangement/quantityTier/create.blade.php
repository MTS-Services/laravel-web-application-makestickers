...
@section('title', 'Create Quantity Tier')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="card-title">Create Quantity Tier</h3>
                    ...
                    <form action="{{ route('am.quantity-tier.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price_multiplier" id="price_multiplier" class="form-control "
                                   value="{{ old('price_multiplier', 1.00) }}" min="0" step="0.01">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Create Quantity</button>
                        </div>
                    </form>
                </div>
            </div>
