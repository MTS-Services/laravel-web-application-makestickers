                ...
                <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
                    ...
                    <form class="space-y-6" action="{{ route('user.op.store') }}" method="POST"
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="w-full border rounded p-2" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="exp_month" name="exp_month" min="1" max="12"
                                    class="w-full border rounded p-2" placeholder="MM" required>
                            </div>
                            <div>
                                ...
                                <input type="number" id="exp_year" name="exp_year" min="2024" max="2100"
                                    class="w-full border rounded p-2" placeholder="YYYY" required>
                            </div>
                        </div>
                        <!-- CVC -->
                        <div>
