  ...
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
    ...
    <div>
      ...
      <div class="flex space-x-4 text-xl">
        ...
        <div class="flex space-x-4 text-xl my-2">
        <a href="#" class="hover:text-gray-300"><i class="fab fa-tiktok"></i></a>
        <a href="#" class="hover:text-gray-300"><i class="fab fa-threads"></i></a>
    ...
    <div>
      ...
      <a href="#" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-black text-sm font-semibold px-4 py-1 rounded">Send a Message</a>
    </div>
