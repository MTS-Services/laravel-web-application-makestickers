...
@section('content')
    ...
    <body>
        <div class="bg-gray-100 py-8 text-center">
            <p class="text-xl text-yellow-500 uppercase tracking-widest mb-1">Careers</p>
        ...
        <div class="py-12 bg-white">
            <div class="container mx-auto px-4">
                <h2 class="text-center text-xl font-semibold text-blue-500 uppercase tracking-wider mb-8">
                    CURRENT POSITIONS
                </h2>
    ...
    <div class="bg-white py-16 px-4 border-t border-gray-300">
      <p class="text-center text-2xl text-gray-700 mb-10">
        We’re a <span class="font-semibold text-yellow-400">technology-focused</span> printing company that’s growing
          ...
          <div class="w-full lg:w-[50%]">
            ...
            <div class="space-y-8"> <!-- More spacing between cards -->
              <div class="border-l-4 border-yellow-400 bg-white p-6 shadow-md rounded">
                ...
                <p class="text-base text-gray-700">We do what we can to help co-workers and ultimately the company as a whole.</p>
              </div>
              <div class="border-l-4 border-lime-500 bg-white p-6 shadow-md rounded">
                ...
                <p class="text-base text-gray-700">We plan ahead and work ahead so that we’re not faced with stressful situations when we need to rush.</p>
              </div>
              <div class="border-l-4 border-blue-500 bg-white p-6 shadow-md rounded">
                ...
                <p class="text-base text-gray-700">We understand that through effort, learning, and practice we can improve over time.</p>
              </div>
              <div class="border-l-4 border-red-500 bg-white p-6 shadow-md rounded">
                ...
                <p class="text-base text-gray-700">We always try to understand their needs and help them succeed.</p>
              </div>
            </div>
          </div>

          <!-- Right: Image Collage -->
          <div class="w-full lg:w-[60%] mt-16 lg:mt-0 flex justify-center lg:justify-end relative">
            <div class="relative w-[320px] h-[540px]"> <!-- Bigger container -->
              <img src="{{asset('frondend/Career Opportunities_image/repair.jpg')}}" class="absolute top-30  left-10 w-44 hight-44 shadow-lg rotate-2 border-4 border-lime-300" alt="Image 1" />
              <img src="{{asset('frondend/Career Opportunities_image/repair.jpg')}}" class="absolute top-60 right-20 w-44 shadow-lg rotate-90 border-4 border-sky-300" alt="Image 2" />
              <img src="{{asset('frondend/Career Opportunities_image/repair.jpg')}}" class="absolute top-80 left-40 w-44 shadow-lg rotate-6 border-4 border-amber-300" alt="Image 3" />
            </div>
          </div>
      ...
      <div class="bg-gray-800 py-10 text-center">
        <h3 class="text-2xl font-semibold text-white mb-8">Get to know us better</h3>
        ...
        <div class="flex flex-wrap justify-center gap-x-12 gap-y-6">
          <a href="#" class="text-gray-300 hover:text-white flex items-center space-x-2">
            ...
            <span class="text-xl sm:text-2xl">Instagram</span>
          </a>
          <a href="#" class="text-gray-300 hover:text-white flex items-center space-x-2">
            <i class="fa-brands fa-facebook text-3xl"></i>
            <span class="text-xl sm:text-2xl">Facebook</span>
          </a>
          <a href="#" class="text-gray-300 hover:text-white flex items-center space-x-2">
            <i class="fa-brands fa-x-twitter text-3xl"></i>
            <span class="text-xl sm:text-2xl">Twitter</span>
          </a>
          <a href="#" class="text-gray-300 hover:text-white flex items-center space-x-2">
            <i class="fa-brands fa-tiktok text-3xl"></i>
            <span class="text-xl sm:text-2xl">TikTok</span>
          </a>
        </div>
      </div>
      ...
      <section class="bg-white-100 py-16">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div class="relative">
            <img src="{{asset('frondend/Career Opportunities_image/repair.jpg')}}" alt="Employee" class="rounded shadow-lg" />

            <!-- Decorative Dots -->
            <div class="absolute top-0 left-0 bg-blue-500 w-10 h-10 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
            <div class="absolute bottom-0 left-0 bg-red-500 w-6 h-6 rounded-full -translate-x-1/2 translate-y-1/2"></div>
            <div class="absolute bottom-0 right-0 bg-lime-500 w-6 h-6 rounded-full translate-x-1/2 translate-y-1/2"></div>
          </div>
        ...
        <div class="bg-white py-16 px-4 border-t border-gray-300">
            <p class="text-center text-2xl text-gray-700 mb-10">
                We’re a <span class="font-semibold text-yellow-400">technology-focused</span> printing company that’s
                growing
                quickly and (almost) always
                <br>
                looking for good people to <a href="#" class="text-blue-500 hover:underline">join our team</a>.
            ...
            <section class=" py-24 px-6"> <!-- Increased vertical padding -->
                <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-12">
                    ...
                    <div class="w-full lg:w-[60%] mt-16 lg:mt-0 flex justify-center lg:justify-end relative">
                        <div class="relative w-[320px] h-[540px]"> <!-- Bigger container -->
                            <div
                                class="relative w-[300px] h-auto after:content[''] after:absolute after:inset-0 after:-rotate-6 after:bg-secondary z-10">
                                <img src="{{ asset('frondend/Career Opportunities_image/printing.jpg') }}"
                                    class="w-full object-cover relative z-10" alt="Image 1" />
                            </div>
                            <div
                                class="relative w-[300px] h-auto after:content[''] after:absolute after:inset-0 after:-rotate-6 after:bg-primary z-10 -ml-20 -mt-20">
                                <img src="{{ asset('frondend/Career Opportunities_image/printing.jpg') }}"
                                    class="w-full object-cover relative z-10" alt="Image 1" />
                            </div>
                            <div
                                class="relative w-[300px] h-auto after:content[''] after:absolute after:inset-0 after:-rotate-6 after:bg-orange z-10 -mt-20">
                                <img src="{{ asset('frondend/Career Opportunities_image/printing.jpg') }}"
                                    class="w-full object-cover relative z-10" alt="Image 1" />
                            </div>
                        </div>
            ...
            <div class="bg-gray-800 py-8 text-center">
                ...
                <div class="flex flex-col items-center justify-center space-y-4">
                    ...
                    <!-- Additional Lines -->
                    <p class="text-gray-300">Don’t see any openings?</p>
                    <p class="text-gray-300">Send your resume to <a href="mailto:careers@graphicsland.com"
                            class="text-blue-400 hover:underline">careers@graphicsland.com</a></p>
                </div>
            </div>
