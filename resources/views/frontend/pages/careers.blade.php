...
@section('content')
    ...
    <body>
        <div class="bg-light-gray py-8 text-center">
            ...
            <h2 class="text-3xl font-bold text-black uppercase tracking-tight mb-4">JOIN THE TEAM</h2>
            <div class="w-12 h-1 bg-orange-hover mx-auto"></div>
        </div>
        <!-- <section class="bg-gray-50 py-16 px-4 md:px-20 text-center"> -->
        <div class="py-12 bg-white">
            <div class="container mx-auto px-4">
                <h2 class="text-center text-xl font-semibold text-primary-hover uppercase tracking-wider mb-8">
                    CURRENT POSITIONS
                </h2>
                ...
                <div class="bg-white rounded-md shadow-lg border border-light-gray mb-6 max-w-3xl mx-auto">
                    <div class="p-6 md:p-8 border-l-4 border-primary-hover bg-white shadow rounded-md">
                        <h3 class="text-xl font-bold text-gray mb-1">Customer Care Specialist</h3>
                        <p class="text-sm text-gray mb-2"><span class="font-bold">Location:</span> Remote</p>
                ...
                <div class="bg-white rounded-md shadow-lg border border-light-gray mb-6 max-w-3xl mx-auto">
                    <div class="p-6 md:p-8 border-l-4 border-primary-hover bg-white shadow rounded-md">
                        <h3 class="text-xl font-bold text-gray mb-1">Laser Finishing Operator</h3>
                        <p class="text-sm text-gray mb-2"><span class="font-bold">Location:</span> Tinley Park, IL</p>
                        <a href="#" class="text-lg font-bold text-primary-hover">+ View details</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-md shadow-lg border border-light-gray mb-6 max-w-3xl mx-auto">
                    <div class="p-6 md:p-8 border-l-4 border-primary-hover bg-white shadow rounded-md">
                        <h3 class="text-xl font-bold text-gray mb-1">Sticker Production Assistant</h3>
                        <p class="text-sm text-gray mb-2"><span class="font-bold">Location:</span> Tinley Park, IL</p>
                        <a href="#" class="text-lg text-primary-hover font-bold text-primary-hover">+ View details</a>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white py-16 px-4 border-t border-gray">
            <p class="text-center text-2xl text-gray mb-10">
            ...
            <section class=" py-24 px-6"> <!-- Increased vertical padding -->
                <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-12">
                    ...
                    <div class="w-full lg:w-[50%]">
                        <h2 class="text-3xl  text-gray mb-10 relative text-center ">
                            Our Values
                        ...
                        <div class="space-y-8"> <!-- More spacing between cards -->
                            <div class="border-l-4 border-orange-hover bg-white p-6 shadow-md rounded">
                                <h3 class="text-orange-hover font-bold mb-3 text-lg">We succeed and fail as a team</h3>
                            ...
                            <div class="border-l-4 border-secondary bg-white p-6 shadow-md rounded">
                                <h3 class="text-secondary font-bold mb-3 text-lg">Do it before it needs to get done</h3>
                            ...
                            <div class="border-l-4 border-tertiary bg-white p-6 shadow-md rounded">
                                <h3 class="text-tertiary font-bold mb-3 text-lg">Empathize with the customer</h3>
            ...
            <section class="bg-light-gray py-16">
                <div class="max-w-7xl mx-auto px-4 text-center">
                    <h2 class="text-2xl font-semibold text-gray mb-8 relative inline-block">
                        Our Benefits
            ...
            <section class="bg-white py-16">
                <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <!-- Right Testimonials -->
                    <div>
                        <h2 class="text-2xl font-semibold text-gray text-center md:text-center mb-6">
                            Employee Voices
                        ...
                        <div class="space-y-4">
                            ...
                            <div class=" border-l-4 border-primary-hover  ">
                                <div class="bg-white rounded-md shadow-lg rounded-md p-4 shadow-sm">
                                    ...
                                    <p class="text-gray text-sm mt-1">Current Employee, 3+ years</p>
                                </div>
                            </div>
                            ...
                            <div class=" border-l-4 border-primary-hover  ">
                                <div class="bg-white rounded-md shadow-lg rounded-md p-4 shadow-sm">
                                    ...
                                    <p class="text-gray text-sm mt-1">Current Employee, 5+ years</p>
                                </div>
                            </div>
                        </div>
                    </div>
