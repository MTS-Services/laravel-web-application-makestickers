    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 my-[50px]">
                @forelse ($custom_labels as $custom_label)
                    <div class="text-center p-2 bg-light-gray rounded-md">
                        <div class="">
                            <img class="w-full mx-auto" src="{{ storage_url($custom_label->image) }}" alt=""
                                style="width: 300px">
                        </div>
                        <div class="p-3">
                    ...
                    @empty
                        <p class="text-font-16px text-gray py-20 text-center">No Custom Label Categories Found</p>
                    @endforelse
                </div>
            </div>
